...
namespace BlyncN
{
    public partial class frmMain : Form
    {
        ...
        private void timerColor_Tick(object sender,EventArgs e) => _con.SetColor();
        ...
        private void btnStop_Click(object sender,EventArgs e) => timerColor.Enabled = false;

        private void tbInterval_Scroll(object sender,EventArgs e) => timerColor.Interval = tbInterval.Value;

        private void btnCustom_Click(object sender,EventArgs e)
        {
            var custom = new frmCustom(_con);

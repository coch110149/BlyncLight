    ...
    public class ColorController
    {
        ...
        private BlyncController.Color Map(LightColor color)
        {
            ...
            switch(color)
            {
                ...
                ret = BlyncController.Color.Cyan;
                break;
                case LightColor.White:
                ret = BlyncController.Color.White;
                break;
                case LightColor.Blue:
                ret = BlyncController.Color.Blue;
                break;
                case LightColor.Yellow:
                ret = BlyncController.Color.Yellow;
                break;
                case LightColor.Green:
                ret = BlyncController.Color.Green;
                break;
                case LightColor.Red:
                ret = BlyncController.Color.Red;
                break;
                case LightColor.Purple:
                ret = BlyncController.Color.Purple;
                break;
                case LightColor.Test:
                ret = BlyncController.Color.Test;
                break;

                default:
                ret = BlyncController.Color.Off;
                break;
            }
            return ret;
        }
        ...
        public void Off()
        {
            if(_con != null)
            {
                _con.Display(Map(LightColor.Off));
            }
        }
